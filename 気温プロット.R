...
plot(data2018[,3], type="l", col=1, xlim=c(1,365), ylim=c(-5,35), ylab="度", main="最高気温[大阪]")
par(new=TRUE)
...
#凡例
labels = c("黒　2018年","赤　2017年","緑　2016年")
pchs   = c(15,15,15)
...
#最低気温
par(new=TRUE, family="HiraKakuProN-W3", xpd=TRUE, xaxt="n", yaxt="n")
plot(data2018[,4], type="l", col=1, xlim=c(1,365), ylim=c(-5,35), xlab="月", ylab="度", main="最低気温[大阪]")
par(new=TRUE)
...
#最高気温
plot(data2018[,3], type="l", lty=2, col=1, xlim=c(1,60), ylim=c(-5,35), xlab="月", ylab="度", main="最高気温と最低気温[大阪]")
par(new=TRUE)
