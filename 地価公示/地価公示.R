...
#グラフィックパラメータ
par(mex="0.2", family="HiraKakuProN-W3", xpd=FALSE, xaxt="n")

#Windows
#par(mex="0.2", xpd=FALSE, xaxt="n")
...
#鉄道　描画
par(new=T)
plot(st_geometry(rails), xlim=c(135.0913,135.7466), ylim=c(34.27182,35.05129), lwd=1, lty="solid", col="blue", bg="transparent")
...
#行政区域　描画
par(new=T)
plot(st_geometry(shape0[,4]), xlim=c(135.0913,135.7466), ylim=c(34.27182,35.05129), border="grey3", main=paste("大阪府　地価公示 (2019年)", sep=""))

##########################################
#凡例
legend("topleft", legend=c("5,000円/㎡","10,000円/㎡","30,000円/㎡","50,000円/㎡","100,000円/㎡","200,000円/㎡","300,000円/㎡","500,000円/㎡","1,000,000円/㎡"), pch=c(16,16,16,16,16,16,16,16), lty=c(1,2,3,4,5,6,7,8), col=c("#5E4FA2","#3288BD","#66C2A5","#ABDDA4","#E6F598","#FEE08B","#FDAE61","#F46D43","#D53E4F","#9E0142"), cex=0.8, bg="white")
